...
## Итог
Мерцание масок создают невыпуклые формы (на границе), резкие изменения, при геометрических обработках это паразитный эффект, при предразметки датасета, анализа сегментов масок нужно применять смуфинг, визуально смуфинг стабилизирует видео и для презентации я бы его применял 100%)
